...
// ReSharper restore UnusedMember.Local
        ...
        public WindowsFileAssociationDetector()
        {
        ...
        public bool? IsAssociated()
        {
            try
            {
                ...
                return doc.IndexOf("ReSharper Gherkin", StringComparison.InvariantCultureIgnoreCase) >= 0;
            }
            catch (Exception)
            {
                return null;
        ...
        private bool EnsureIcon(string iconPath)
        {
            ...
            {
                var iconResource = GetType().Assembly.GetManifestResourceStream("ReSharperPlugin.SpecflowRiderPlugin.Icons.gherkin.ico");
        ...
        public bool SetAssociation()
        {
            try
            {
                ...
                const string extension = ".feature";
                const string friendlyTypeName = "ReSharper Gherkin Specification File for SpecFlow";
